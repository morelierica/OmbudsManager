...
namespace TG.View
{
    public partial class PesquisaManifestante : Form
    {
        public PesquisaManifestante()
        {
            InitializeComponent();
        }
        ...
        private void PesquisaManifestante_Load(object sender, EventArgs e)
        {
        ...
        private void buttonSelecionar_Click(object sender, EventArgs e)
        {
            ...
            View.EditarManifestante editarManifestante = new View.EditarManifestante(cod_selecionado);
            editarManifestante.Show();
            this.Close();
        }
